...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFAnimNode_JumpingCompression
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_JumpingCompression>(FName(TEXT("AnimNode_JumpingCompression")));
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_JumpingCompression_Statics::NewProp_bWorkOutsidePIE_MetaData[] = {
		{ "Category", "Jump" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_JumpingCompression_Statics::NewProp_bWorkOutsidePIE = { "bWorkOutsidePIE", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_JumpingCompression), &Z_Construct_UScriptStruct_FAnimNode_JumpingCompression_Statics::NewProp_bWorkOutsidePIE_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_JumpingCompression_Statics::NewProp_bWorkOutsidePIE_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_JumpingCompression_Statics::NewProp_bWorkOutsidePIE_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAnimNode_JumpingCompression_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimNode_JumpingCompression_Statics::NewProp_bWorkOutsidePIE,
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_JumpingCompression_Hash() { return 920722423U; }
