...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFAnimNode_FootIK
{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableDebugDrawPIE_MetaData[];
#endif
		static void NewProp_bEnableDebugDrawPIE_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableDebugDrawPIE;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bWorkOutsidePIE_MetaData[] = {
		{ "Category", "IK Config" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bWorkOutsidePIE = { "bWorkOutsidePIE", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_FootIK), &Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bWorkOutsidePIE_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bWorkOutsidePIE_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bWorkOutsidePIE_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bEnableDebugDrawPIE_MetaData[] = {
		{ "Category", "Debug" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bEnableDebugDrawPIE = { "bEnableDebugDrawPIE", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_FootIK), &Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bEnableDebugDrawPIE_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bEnableDebugDrawPIE_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bEnableDebugDrawPIE_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bWorkOutsidePIE,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimNode_FootIK_Statics::NewProp_bEnableDebugDrawPIE,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_FootIK_Hash() { return 589448004U; }
...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFMIFootIK_Foot
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMIFootIK_Foot>(FName(TEXT("MIFootIK_Foot")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMIFootIK_Foot_Hash() { return 2035262803U; }
...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFMIFootIK_State
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMIFootIK_State>(FName(TEXT("MIFootIK_State")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMIFootIK_State_Hash() { return 1676669050U; }
