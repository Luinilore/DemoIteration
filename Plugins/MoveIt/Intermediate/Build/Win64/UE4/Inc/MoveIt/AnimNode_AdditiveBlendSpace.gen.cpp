...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MoveIt_EMIAdditiveType_Hash() { return 4131847518U; }
...
static_assert(std::is_polymorphic<FAnimNode_AdditiveBlendSpace>() == std::is_polymorphic<FAnimNode_BlendSpacePlayer>(), "USTRUCT FAnimNode_AdditiveBlendSpace cannot be polymorphic unless super FAnimNode_BlendSpacePlayer is polymorphic");
...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFAnimNode_AdditiveBlendSpace
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_AdditiveBlendSpace>(FName(TEXT("AnimNode_AdditiveBlendSpace")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_AdditiveBlendSpace_Hash() { return 1818409657U; }
