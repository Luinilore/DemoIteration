...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AnimGraphNode_LandingPose.h" },
		{ "ModuleRelativePath", "Public/AnimGraphNode_LandingPose.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::NewProp_Node_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/AnimGraphNode_LandingPose.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::NewProp_Node = { "Node", nullptr, (EPropertyFlags)0x0010008000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimGraphNode_LandingPose, Node), Z_Construct_UScriptStruct_FAnimNode_LandingPose, METADATA_PARAMS(Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::NewProp_Node_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::NewProp_Node_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::NewProp_Node,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UAnimGraphNode_LandingPose()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimGraphNode_LandingPose_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimGraphNode_LandingPose, 2834889371);
	template<> MOVEITEDITOR_API UClass* StaticClass<UAnimGraphNode_LandingPose>()
	{
		return UAnimGraphNode_LandingPose::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimGraphNode_LandingPose(Z_Construct_UClass_UAnimGraphNode_LandingPose, &UAnimGraphNode_LandingPose::StaticClass, TEXT("/Script/MoveItEditor"), TEXT("UAnimGraphNode_LandingPose"), false, nullptr, nullptr, nullptr);
