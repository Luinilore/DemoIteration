...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFAnimNode_LandFootIK
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_LandFootIK>(FName(TEXT("AnimNode_LandFootIK")));
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::NewProp_PredictedLanding_MetaData[] = {
		{ "Category", "Land" },
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::NewProp_bWorkOutsidePIE_MetaData[] = {
		{ "Category", "Land" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::NewProp_bWorkOutsidePIE = { "bWorkOutsidePIE", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_LandFootIK), &Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::NewProp_bWorkOutsidePIE_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::NewProp_bWorkOutsidePIE_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::NewProp_bWorkOutsidePIE_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::NewProp_PredictedLanding,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Statics::NewProp_bWorkOutsidePIE,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_LandFootIK_Hash() { return 2205879871U; }
...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFMIFoot_LandFootIK
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMIFoot_LandFootIK>(FName(TEXT("MIFoot_LandFootIK")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMIFoot_LandFootIK_Hash() { return 893807689U; }
