...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFAnimNode_JumpFootIK
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_JumpFootIK>(FName(TEXT("AnimNode_JumpFootIK")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_JumpFootIK_Hash() { return 1528502604U; }
...
static struct FScriptStruct_MoveIt_StaticRegisterNativesFMIJumpFootIK_Foot
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMIJumpFootIK_Foot>(FName(TEXT("MIJumpFootIK_Foot")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMIJumpFootIK_Foot_Hash() { return 4157835478U; }
