...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableOutsideGameWorld_MetaData[];
#endif
		static void NewProp_bEnableOutsideGameWorld_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableOutsideGameWorld;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMIAnimNotify_Footstep_Statics::NewProp_bEnableOutsideGameWorld_MetaData[] = {
		{ "Category", "AnimNotify" },
		{ "ModuleRelativePath", "Public/MIAnimNotify_Footstep.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMIAnimNotify_Footstep_Statics::NewProp_bEnableOutsideGameWorld = { "bEnableOutsideGameWorld", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMIAnimNotify_Footstep), &Z_Construct_UClass_UMIAnimNotify_Footstep_Statics::NewProp_bEnableOutsideGameWorld_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMIAnimNotify_Footstep_Statics::NewProp_bEnableOutsideGameWorld_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMIAnimNotify_Footstep_Statics::NewProp_bEnableOutsideGameWorld_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMIAnimNotify_Footstep_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMIAnimNotify_Footstep_Statics::NewProp_bEnableOutsideGameWorld,
	};
	...
	IMPLEMENT_CLASS(UMIAnimNotify_Footstep, 3929870954);
